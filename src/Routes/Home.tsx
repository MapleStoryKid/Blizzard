...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 139.85" style={{ height: '200px', width: '400px',margin: '0 auto' }}>
...
export const FloatingPengGu = styled.img`
position: absolute;
width: 280px;
bottom: -300px;
right: -120px;
